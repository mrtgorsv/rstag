...
namespace RstegApp.Logic.Utils
{
...
//[StructLayout(LayoutKind.Explicit, Size = 160)]
    public struct WINDIVERT_IPHDR
    {
        ...
        {
            get { return (uint) (bitvector1 & 15u); }
        ...
        public uint Version
        {
            get
            {
                return (uint) ((bitvector1 & 240u)
                               / 16);
            }
            set
            {
                bitvector1 = (byte) ((value * 16)
                                     | bitvector1);
            }
        }
        ...
        {
            get { return new IPAddress(unchecked((long) SourceAddress)); }

            set
            {
                Debug.Assert(value.AddressFamily == System.Net.Sockets.AddressFamily.InterNetwork,
                    Resources.NotValidIp4AddressException);

                if (value.AddressFamily != System.Net.Sockets.AddressFamily.InterNetwork)
                {
                    throw new ArgumentException(Resources.NotValidIp4AddressException, nameof(SrcAddr));
                }
        ...
        {
            get { return new IPAddress(unchecked((long) DestinationAddress)); }
            ...
            set
            {
                ...
                if (value.AddressFamily != System.Net.Sockets.AddressFamily.InterNetwork)
                {
                    throw new ArgumentException(Resources.NotValidIp4AddressException, nameof(DstAddr));
                }
    ...
    public unsafe struct WINDIVERT_IPV6HDR
    {
        ...
        public uint FlowLabel0
        {
            get
            {
                return (uint) ((bitvector1 & 3840u)
                               / 256);
            }
            set
            {
                bitvector1 = (ushort) ((value * 256)
                                       | bitvector1);
            }
        }
        ...
        public uint TrafficClass1
        {
            get
            {
                return (uint) ((bitvector1 & 61440u)
                               / 4096);
            }
            set
            {
                bitvector1 = (ushort) ((value * 4096)
                                       | bitvector1);
            }
        }
        ...
        public IPAddress SrcAddr
        {
            ...
            set
            {
                fixed (uint* addr = SourceAddress)
                {
                    ...
                    Debug.Assert(valueBytes.Length == 16, Resources.NotValidIp6AddressException);

                    if (valueBytes.Length != 16)
                    {
                        throw new ArgumentException(Resources.NotValidIp6AddressException, nameof(SrcAddr));
                    }
        ...
        public IPAddress DstAddr
        {
            ...
            set
            {
                fixed (uint* addr = DestinationAddress)
                {
                    ...
                    if (valueBytes.Length != 16)
                    {
                        throw new ArgumentException(Resources.NotValidIp6AddressException, nameof(DstAddr));
                    }
    ...
    public struct WINDIVERT_TCPHDR
    {
        ...
        public uint Syn
        {
            get
            {
                return (uint) ((bitvector1 & 512u)
                               / 512);
            }
            set
            {
                bitvector1 = (ushort) ((value * 512)
                                       | bitvector1);
            }
        }
        ...
        public uint Rst
        {
            get
            {
                return (uint) ((bitvector1 & 1024u)
                               / 1024);
            }
            set
            {
                bitvector1 = (ushort) ((value * 1024)
                                       | bitvector1);
            }
        }
        ...
        public uint Psh
        {
            get
            {
                return (uint) ((bitvector1 & 2048u)
                               / 2048);
            }
            set
            {
                bitvector1 = (ushort) ((value * 2048)
                                       | bitvector1);
            }
        }
        ...
        public uint Urg
        {
            get
            {
                return (uint) ((bitvector1 & 8192u)
                               / 8192);
            }
            set
            {
                bitvector1 = (ushort) ((value * 8192)
                                       | bitvector1);
            }
        }
        ...
        public uint Reserved2
        {
            get
            {
                return (uint) ((bitvector1 & 49152u)
                               / 16384);
            }
            set
            {
                bitvector1 = (ushort) ((value * 16384)
                                       | bitvector1);
            }
        }
    }
    ...
    public struct Anonymous_7416d31a_1ce9_4e50_b1e1_0f2ad25c0196
    {
        ...
        [FieldOffset(0)] public Anonymous_ac6e4301_4438_458f_96dd_e86faeeca2a6 Struct1;
    ...
    public class WinDivertMethods
    {
        ...
        public static extern IntPtr WinDivertOpen([In] [MarshalAs(UnmanagedType.LPStr)] string filter,
        ...
        public static extern bool WinDivertRecv([In] IntPtr handle, byte[] pPacket, uint packetLen,
            ref WINDIVERT_ADDRESS pAddr, ref uint readLen);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool WinDivertRecvEx([In] IntPtr handle, byte[] pPacket, uint packetLen, ulong flags,
            IntPtr pAddr, IntPtr readLen, IntPtr lpOverlapped);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool WinDivertSend([In] IntPtr handle, [In] byte[] pPacket, uint packetLen,
            [In] ref WINDIVERT_ADDRESS pAddr, IntPtr writeLen);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool WinDivertSendEx([In] IntPtr handle, [In] byte[] pPacket, uint packetLen, ulong flags,
            [In] ref WINDIVERT_ADDRESS pAddr, IntPtr writeLen, IntPtr lpOverlapped);
        ...
        public static unsafe extern bool WinDivertHelperParsePacket(
            [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] byte[] pPacket, uint packetLen,
            WINDIVERT_IPHDR** ppIpHdr, WINDIVERT_IPV6HDR** ppIpv6Hdr, WINDIVERT_ICMPHDR** ppIcmpHdr,
            WINDIVERT_ICMPV6HDR** ppIcmpv6Hdr, WINDIVERT_TCPHDR** ppTcpHdr, WINDIVERT_UDPHDR** ppUdpHdr, byte** ppData,
            uint* pDataLen);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool WinDivertHelperParseIPv4Address([In] [MarshalAs(UnmanagedType.LPStr)] string addrStr,
            IntPtr pAddr);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool WinDivertHelperParseIPv6Address([In] [MarshalAs(UnmanagedType.LPStr)] string addrStr,
            IntPtr pAddr);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool WinDivertHelperCheckFilter([In] [MarshalAs(UnmanagedType.LPStr)] string filter,
            WINDIVERT_LAYER layer, ref IntPtr errorStr, IntPtr errorPos);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool WinDivertHelperEvalFilter([In] [MarshalAs(UnmanagedType.LPStr)] string filter,
            WINDIVERT_LAYER layer, [In] byte[] pPacket, uint packetLen, [In] ref WINDIVERT_ADDRESS pAddr);
    }
}